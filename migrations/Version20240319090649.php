 ...
 */
final class Version20240319090649 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE client (id INT AUTO_INCREMENT NOT NULL, employe_id INT NOT NULL, reference_client VARCHAR(7) NOT NULL, nom VARCHAR(50) NOT NULL, prenom VARCHAR(50) NOT NULL, sexe VARCHAR(30) NOT NULL, email VARCHAR(70) NOT NULL, adresse VARCHAR(70) DEFAULT NULL, cp VARCHAR(5) DEFAULT NULL, ville VARCHAR(50) DEFAULT NULL, telephone VARCHAR(10) NOT NULL, type VARCHAR(30) NOT NULL, coefficient NUMERIC(3, 2) NOT NULL, reduction NUMERIC(3, 2) NOT NULL, INDEX IDX_C74404551B65292 (employe_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, numero_facture INT DEFAULT NULL, date_facture DATETIME DEFAULT NULL, date_commande DATETIME NOT NULL, total_commande NUMERIC(8, 2) NOT NULL, adresse_livraison VARCHAR(70) NOT NULL, cp_livraison VARCHAR(5) NOT NULL, ville_livraison VARCHAR(50) NOT NULL, adresse_facturation VARCHAR(70) NOT NULL, cp_facturation VARCHAR(5) NOT NULL, ville_facturation VARCHAR(50) NOT NULL, statut VARCHAR(30) NOT NULL, payee TINYINT(1) NOT NULL, mode_paiement VARCHAR(30) NOT NULL, total_paye NUMERIC(8, 2) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE employe (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT NOT NULL, nom VARCHAR(50) NOT NULL, prenom VARCHAR(50) NOT NULL, email VARCHAR(70) NOT NULL, poste VARCHAR(50) NOT NULL, telephone VARCHAR(10) NOT NULL, sexe VARCHAR(30) DEFAULT NULL, adresse VARCHAR(100) DEFAULT NULL, INDEX IDX_F804D3B9FB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE ligne_commande (id INT AUTO_INCREMENT NOT NULL, commande_id INT NOT NULL, quantite INT NOT NULL, libelle VARCHAR(70) NOT NULL, prix_vente NUMERIC(8, 2) NOT NULL, INDEX IDX_3170B74B82EA2E54 (commande_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ligne_livraison (id INT AUTO_INCREMENT NOT NULL, livraison_id INT NOT NULL, quantite_livree INT NOT NULL, INDEX IDX_69E990978E54FB25 (livraison_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE livraison (id INT AUTO_INCREMENT NOT NULL, commande_id INT NOT NULL, numero_bon_livraison INT NOT NULL, date_livraison DATETIME NOT NULL, observation VARCHAR(255) DEFAULT NULL, INDEX IDX_A60C9F1F82EA2E54 (commande_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE produit (id INT AUTO_INCREMENT NOT NULL, fournisseur_id INT NOT NULL, categorie_id INT NOT NULL, ligne_commande_id INT NOT NULL, ligne_livraison_id INT NOT NULL, reference VARCHAR(6) NOT NULL, libelle VARCHAR(70) NOT NULL, dimenssion VARCHAR(50) DEFAULT NULL, couleur VARCHAR(50) DEFAULT NULL, description LONGTEXT NOT NULL, prix_achat NUMERIC(8, 2) NOT NULL, photo VARCHAR(70) NOT NULL, actif TINYINT(1) NOT NULL, quantite_stock INT NOT NULL, stock_alert INT NOT NULL, INDEX IDX_29A5EC27670C757F (fournisseur_id), INDEX IDX_29A5EC27BCF5E72D (categorie_id), INDEX IDX_29A5EC27E10FEE63 (ligne_commande_id), INDEX IDX_29A5EC27368ABBEA (ligne_livraison_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, client_id INT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, nom VARCHAR(50) NOT NULL, prenom VARCHAR(50) NOT NULL, INDEX IDX_1D1C63B319EB6921 (client_id), UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
